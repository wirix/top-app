import { HhData, Htag, Tag, Sort, Product } from "../../components";
...
export const TopPageComponent = ({ firstCategory, page, products }: TopPageComponentProps): JSX.Element => {
  ...
  // это хук уменьшение движение, если вкл то уменьшает
  ...
  return (
    <div className={styles.wrapper}>
      <div className={styles.title}>
        <Htag tag="h1" tabIndex={0} >{page.title}</Htag>
        {products && <Tag tabIndex={0} aria-label={products.length + 'элементов'} color="gray" size="m">{products.length}</Tag>}
